...
import TransactionSearch from "@/components/TransactionSearch"; // ✅ Import Search
        ...
        <table className="w-full text-left">
          <thead className="bg-[#e6f0ff] border-b border-gray-300 text-[11px] font-bold text-[#003366] uppercase">
            <tr>
              ...
              <th className="px-4 py-3 text-center">Txn ID</th>
            </tr>
          </thead>
              ...
              <tr key={v.id} className="hover:bg-yellow-50 transition-colors">
                ...
                <td className="px-4 py-3 border-r">
                  ...
                  <div className="text-[10px] text-gray-500 mt-0.5">
                    By: {v.createdBy?.username || "Unknown"}
                  </div>
                </td>
